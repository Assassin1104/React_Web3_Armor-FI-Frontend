import { Armor_WBTC_1inch_FarmEvents } from './armor_WBTC_1inch_FarmEvents'
import { Armor_WBTC_1inch_TokenEvents } from './armor_WBTC_1inch_TokenEvents'
import * as BN from 'bn.js'

class Armor_WBTC_1inch_FarmContract {
  constructor(service) {
    this.service = service
  }

  shouldDispatch(payload) {
    return this.service.shouldDispatch(Armor_WBTC_1inch_FarmEvents, payload)
  }

  async dispatch(payload) {
    switch (payload.type) {
      case Armor_WBTC_1inch_FarmEvents.GetStakedArmor:
        await this.getStakedArmor(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.GetOwnedArmor:
        await this.getOwnedArmor(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.GetRewardsOwed:
        await this.getRewardsOwed(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.GetRewardsGiven:
        await this.getRewardsGiven(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.GetTotalRewardsGiven:
        await this.getTotalRewardsGiven(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.GetTotalStakers:
        await this.getTotalStakers(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.Stake:
        await this.stake(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.ClaimRewards:
        await this.claimRewards(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.Withdraw:
        await this.withdraw(payload)
        break
      case Armor_WBTC_1inch_FarmEvents.Exit:
  ...
  async getStakedArmor(payload) {
    ...
    this.service.setStore({
      Armor_WBTC_1inch_Farm_StakedArmor: !response
        ? '0'
        : web3.utils.fromWei(response.toString(), 'ether'),
    })
    this.service.emit(Armor_WBTC_1inch_FarmEvents.StakedArmorReturned)
    ...
    return new Promise(async (resolve, reject) => {
      try {
        const contract = this.service.makeContract(
          web3,
          this.service.config.armor_WBTC_1inch_Farm.abi,
          this.service.config.armor_WBTC_1inch_Farm.address
        )
  ...
  async getOwnedArmor(payload) {
    ...
    let lpTokenTotal = await this.service.contracts.armor_WBTC_1inch_Token
    ...
    this.service.setStore({
      Armor_WBTC_1inch_Farm_OwnedArmor:
        total === null ? 0 : web3.utils.fromWei(total.toString(), 'ether'),
    })

    this.service.emit(Armor_WBTC_1inch_FarmEvents.OwnedArmorReturned)
  ...
  async getRewardsOwed(payload) {
    ...
    this.service.setStore({ Armor_WBTC_1inch_Farm_RewardsOwed: response })
    this.service.emit(Armor_WBTC_1inch_FarmEvents.RewardsOwedReturned)
  ...
  async getRewardsGiven(payload) {
    ...
    this.service.setStore({ Armor_WBTC_1inch_Farm_RewardsGiven: response })
    this.service.emit(Armor_WBTC_1inch_FarmEvents.RewardsGivenReturned)
  ...
  async getTotalRewardsGiven(payload) {
    ...
    this.service.setStore({ Armor_WBTC_1inch_Farm_TotalRewardsGiven: response })
    this.service.emit(Armor_WBTC_1inch_FarmEvents.TotalRewardsGivenReturned)
  ...
  async getTotalStakers(payload) {
    ...
    this.service.setStore({ Armor_WBTC_1inch_Farm_TotalStakers: response })
    this.service.emit(Armor_WBTC_1inch_FarmEvents.TotalStakersReturned)
  ...
  async stake(payload) {
    ...
    let ownedArmor = await this.service.contracts.armor_WBTC_1inch_Token
      .getBalance(account.address)
      .catch((err) => {
        this.service.emitError(err)
        return null
    ...
    await this.service.contracts.armor_WBTC_1inch_Token
      .approve({
        content: {
          toAddress: this.service.config.armor_WBTC_1inch_Farm.address,
          amount: userAmount,
        },
      })
      .catch((err) => {
    ...
    this.service.emit(Armor_WBTC_1inch_TokenEvents.StakeCompleted, response)
    return response
  }
  ...
  async claimRewards(payload) {
    ...
    this.service.emit(
      Armor_WBTC_1inch_TokenEvents.ClaimRewardsCompleted,
      response
    )
    return response
  }
  ...
  async withdraw(payload) {
    ...
    this.service.emit(Armor_WBTC_1inch_TokenEvents.WithdrawCompleted, response)
    return response
  }
  ...
  dispatchAll() {
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_TokenEvents.GetBalance,
      content: {},
    })
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_FarmEvents.GetStakedArmor,
      content: {},
    })
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_FarmEvents.GetOwnedArmor,
      content: {},
    })
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_FarmEvents.GetRewardsOwed,
      content: {},
    })
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_FarmEvents.GetRewardsGiven,
      content: {},
    })
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_TokenEvents.GetTotalArmorStaked,
      content: {},
    })
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_FarmEvents.GetTotalRewardsGiven,
      content: {},
    })
    this.service.dispatcher.dispatch({
      type: Armor_WBTC_1inch_FarmEvents.GetTotalStakers,
      content: {},
    })
  }
}

export default Armor_WBTC_1inch_FarmContract
